    ...
    <div className="flex flex-col h-full bg-[#0a0a0a]">
      ...
      {messages.length === 0 ? (
        ...
        <div className="flex flex-col h-full">
                    ...
                    {message.files && message.files.length > 0 && (
                      ...
                      >
                        {message.files.map((file, index) => (
                          ...
                          >
                            <svg
                              className={`text-cyan-400/80 mr-2 ${
                    ...
                    {message.aiResponse && !message.isLoading && (
                      <div>
                            ...
                            components={{
                              ...
                              code: ({ node, inline, ...props }) =>
                                inline ? (
                                  ...
                                  <code
                                    className="block bg-gray-800 p-3 rounded-lg my-2 text-sm overflow-x-auto"
                                    {...props}
                                  />
                                ),
                            }}
                        ...
                        {message.aiResponse.retrieval && (
                          <div
                            className={`mt-4 pt-4 border-t border-gray-700/30 flex items-center justify-between ${
                              isMobile ? "text-xs" : "text-xs sm:text-sm"
                            }`}
                          >
                            ...
                            {message.aiResponse.retrieval.processingTime && (
                              <span className="text-gray-500">
                                {message.aiResponse.retrieval.processingTime.toFixed(
                                  2,
                                )}
                                s
                              </span>
          ...
          {/* Bottom input */}
          <div
            className={`border-t border-gray-700/50 bg-[#0a0a0a]/95 backdrop-blur-sm ${
