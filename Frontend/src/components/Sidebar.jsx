...
const Sidebar = ({
  ...
  return (
    <>
      ...
      {/* Fixed Sidebar */}
      <div
        className={`fixed left-0 top-0 h-screen bg-[#0a0a0a] border-r border-gray-700 z-30 transition-all duration-300 ${
          isMobile
      ...
      >
        <div className="flex flex-col h-full">
                        ...
                        <div className="flex items-center min-w-0 flex-1">
                          ...
                          >
                            <path
                              ...
                              strokeLinejoin="round"
                              strokeWidth={2}
                              d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-3.582 8-8 8a8.955 8.955 0 01-2.646-.388l-2.729 1.093a.5.5 0 01-.67-.65L8.051 17.95A8 8 0 1121 12z"
                            />
                          </svg>
                          {(!collapsed || isMobile) && (
          ...
          <div
            className="flex-shrink-0 p-4 border-t border-gray-700/50 relative"
            ref={userMenuRef}
          >
            ...
            {showUserMenu && (!collapsed || isMobile) && (
              <div
                className={`absolute bottom-full left-4 right-4 mb-2 bg-[#2a2a2a] border border-gray-600 rounded-lg shadow-xl z-50 ${
      ...
      {/* Mobile Overlay */}
      {!collapsed && isMobile && (
        <div className="fixed inset-0 bg-black/50 z-20" onClick={onToggle} />
      )}
    </>
  );
};
